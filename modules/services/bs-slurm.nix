    ...
    services.bs-slurm = {
      ...
      client = {
        ...
        nodeId = mkOption {
          type = types.int;
          default = 1;
          description = "The node's id, default 1, node1 (use with  multiple-slurmd option , -N node1)";
        };
        rangeId = mkOption {
          type = types.int;
          default = 1;
          description = "The number of ids use with multiple-slurmd option";
        };
      };
      ...
      package = mkOption {
        type = types.package;
        default = pkgs.nur.repos.augu5te.bs-slurm;
        defaultText = "pkgs.nur.repos.augu5te.bs-slurm";
